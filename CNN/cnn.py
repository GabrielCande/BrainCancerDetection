...
results_folder = "CNNresults"
models_folder = "CNNmodels"
historys_folder = "BrainCancerDetection/Historicos/CNN"
...
if use_pretrained == "yes":
    ...
    if os.path.exists(model_path):
        cnnModel = tf.keras.models.load_model(model_path)
...
if use_pretrained != "yes":
    ...
    cnnModel = Sequential()
    cnnModel.add(Conv2D(64, kernel_size=(3, 3), activation='relu', input_shape=input_shape))
    cnnModel.add(Conv2D(64, kernel_size=(3, 3), activation='relu'))
    cnnModel.add(MaxPooling2D(pool_size=(2, 2)))
    cnnModel.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
    cnnModel.add(MaxPooling2D(pool_size=(2, 2)))
    cnnModel.add(Conv2D(128, kernel_size=(3, 3), activation='relu'))
    cnnModel.add(MaxPooling2D(pool_size=(2, 2)))
    cnnModel.add(Dropout(0.5))
    cnnModel.add(Flatten())
    cnnModel.add(Dense(256, activation='relu'))
    cnnModel.add(Dense(256, activation='sigmoid'))
    cnnModel.add(Dropout(0.2))
    cnnModel.add(Dense(num_classes, activation='sigmoid')) 
