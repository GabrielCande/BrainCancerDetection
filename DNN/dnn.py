...
results_folder = "DNNresults"
models_folder = "DNNmodels"
historys_folder = "BrainCancerDetection/Historicos/DNN"
...
if use_pretrained == "yes":
    ...
    if os.path.exists(model_path):
        dnnModel = tf.keras.models.load_model(model_path)
...
if use_pretrained != "yes":
    ...
    dnnModel = Sequential()
    dnnModel.add(Flatten(input_shape=input_shape))
    ...
    dnnModel.add(Dense(4, activation = "sigmoid"))
